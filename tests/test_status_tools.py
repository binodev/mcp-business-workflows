...
from mcp_business_workflows.schemas.status import ConnectorHealth, ConnectorStatus, GetSystemStatusInput
from mcp_business_workflows.services.status_service import StatusService, _check_github, _check_webhook
...
class TestStatusService:
    def test_overall_healthy_when_all_connectors_ok(self, service: StatusService) -> None:
        with patch("mcp_business_workflows.services.status_service._CHECKERS", {
